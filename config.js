window.config = {
  ...
  map: {
    ...
    'devextreme/bundles/dx.all': 'npm:devextreme@22.2.3/bundles/dx.all.js',
    ...
    'devextreme-angular': 'npm:devextreme-angular@22.2.3',
  ...
  packageConfigPaths: [
    ...
    'npm:devextreme-angular@22.2.3/*/package.json',
    'npm:devextreme-angular@22.2.3/ui/*/package.json',
    'npm:devextreme-angular@22.2.3/package.json',
    'npm:devexpress-diagram@2.1.65/package.json',
    'npm:devexpress-gantt@4.1.37/package.json',
  ],
};
